...
Step 4. Update System and Install LEMP Packages
...
server {
        listen 80;
        server_name (YOUR AWS HTTP LINK HERE);
...
Step 8. Finish WordPress Install
...
WordPress database setupPin


Upon completion of the installation, you can access your WordPress administrator dashboard at http://example.com/wp-admin/ where example.com is your domain name. You can use any domain name (customize) you want.

Step 9. Install PHP Packages Required by WordPress
